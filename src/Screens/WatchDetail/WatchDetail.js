                        ...
                        <div class="row">
                                ...
                                <div id="demo" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src={require('../../assets/icons/xd/watch-detail/watch-1/slider-image-1.png')} alt="Slider1" class="wd-100" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src={require('../../assets/icons/xd/watch-detail/watch-1/slider-image-2.png')} alt="Slider2" class="wd-100" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src={require('../../assets/icons/xd/watch-detail/watch-1/slider-image-3.png')} alt="Slider3" class="wd-100" />
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 pl-30 pt-50 mb-50">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="watch-detail-h2">Hublot</h3>
                                            <img class="watch-detail-flag" src={require('../../assets/flags/de.png')} alt="Germany Flag" />
                                            <p class="mb-10 dark-color">Sphere Bassilica - Gray 2A7865</p>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pl-0 pr-0">
                                            <form action="#">
                                                ...
                                                <input class="acc-profile-btn-one" type="button" value="Ask a Question" class="wd-100" />
                                            </form>
                                        </div>
                                            ...
                                            <div class="row bid-quote mr-0 ml-0 mb-15">
                                                <div>
                                                    <div class="col-md-12 text-center">
                                                        <img src={require('../../assets/icons/xd/icons/quote.png')} alt="" />
